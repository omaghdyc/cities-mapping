...
$sapressCities = [
    ...
    "Bni khloug",
    "Guisser",
    "Quasbatt dar chafaye",
    "Berrechid",
    "Settat",
    "El borouj",
    "Zaouiet Sidi Ali Ben Nouini",
    "Kasbat ben mchich",
    "Oulad h'riz sahel",
    "Zaouiet sidi el mekki",
    "El gara",
    "Oulad abbou",
    "Ouled faress",
...
$commonCities = [];
foreach ($sapressCities as $sapressCity) {
    $maxDistance = 2;
    $similarities = $fuzzy->search($sapressCity, $maxDistance);

    if(count($similarities) === 0) continue;

    $commonCities[] = [
        'sapress_city_name' => $sapressCity,
...
echo "<pre>";
echo 'YCS City ID,YCS City Name,Sapress City Name<br>';
foreach ($commonCities as $city) {
    echo sprintf(
        '%s,%s,%s<br>', 
        $city['ship_city_id'],
        $city['ship_city_name'],
        $city['sapress_city_name']
    );
}
